...
class TestSignalImplanter(TestCase):
    ...
    def test_run(self):
        ...
        simulation = Simulation(
            [Implanting(dataset_implanting_rate=0.2, repertoire_implanting_rate=0.5, signals=[s1, s2], name="i1"),
        ...
        self.assertTrue(
            all([repertoire.data_filename.name in metadata_filenames for repertoire in new_dataset.repertoires]))
    ...
    def test_run_with_receptors(self):
        ...
        motif1 = Motif(identifier="motif1", instantiation=GappedKmerInstantiation(), seed_chain1="AAA",
                       name_chain1=Chain.ALPHA, seed_chain2="CCC",
                       name_chain2=Chain.BETA)
        signal1 = Signal(identifier="signal1", motifs=[motif1],
                         implanting_strategy=ReceptorImplanting(GappedMotifImplanting()))
        ...
        self.assertEqual(5, len([receptor for receptor in new_dataset.get_data(40) if
                                 receptor.metadata["signal1"] is True]))
